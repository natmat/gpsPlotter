...
class Navigation():
    ...
    def setGpsPoint(self, gps_map, gps_point, gps_previous):
    ...
    def newNavigationMessage(cls, line):
        ...
        if False:
            ...
            print(dict_names)
            d = dict(zip(dict_names, split_line))
            print(d['lat'])
            print(d)
    ...
    #         if ((n.gps_point.confidence != "low" and n.gps_point.confidence != "error") and
    #                 (float(n.gps_point.dist) < 1.0 and float(self.gps_previous.dist) >= 1.0)):
    #             i_marker_count[0] += 1
    ...
    #         if (n.gps_point.confidence == 'high' and n.gps_point.confidence == self.gps_previous.confidence):
